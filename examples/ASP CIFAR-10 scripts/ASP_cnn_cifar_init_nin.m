function net = cnn_cifar_init_ninASP(~)
...
%                            'name', 'conv1', ...
%                            'weights', {{0.01*randn(5,5,12,192,'single'), b*ones(1,192,'single')}}, ... % randn(5,5,25,192,'single') 
%                            'learningRate', [.1 2], ...
%                            'stride', 1, ...
%                            'pad', 2) ;
...
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'cccp1', ...
                           'weights', {{0.05*randn(1,1,12,160, 'single'), b*ones(1,160,'single')}}, ...
                           'learningRate', [.1 2], ...
                           'stride', 1, ...
                           'pad', 0) ;
...
vl_simplenn_display(net,'inputSize', [32 32 12 100])
%keyboard
